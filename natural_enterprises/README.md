...
- [ ] Add an email address to the `ADMINS` settings variable in `natural_enterprises/natural_enterprises/settings/base.py`
...
- Create a copy of ``natural_enterprises/settings/local.py.example``:  
  `cp natural_enterprises/settings/local.py.example natural_enterprises/settings/local.py` (remembering you should replace `natural_enterprises` with your project's name!).
